...
var products=[
  ...
  },
  {
    ...
    off: "28%",
    info: { reviews: 100, discount: 10, brand: "Thor Kitchen", availability: true, style: 'Modern & Contemporary' }
  },
  {
    name: "Proscenic T22 Smart Electric Air Fryer Oil-Free Non-stick Pan 5L 3D HF Circulation Technology 100 Recipes 11 Programs LED Display App and Voice Control - Black",
    ...
    details:
      "",
    off: "27%",
    info: { reviews: 1000, discount: 30, brand: "Waterford", availability: true, style: 'Modern & Contemporary' }
  },
  {
    name: "Caynel 4-Liter Portable Mini Fridge for Home, Office and Car, AC/DC Thermoelectric System",
    img_url: [
      "https://bit.ly/3vG9OFj",
  ...
  },
  {
    ...
    off: "14%",
    info: { reviews: 200, discount: 20, brand: "Haden", availability: true, style: 'Modern & Contemporary' }
  },
  {
    ...
    off: "27%",
    info: { reviews: 249, discount: 10, brand: "Farberware", availability: true, style: 'Modern & Contemporary' }
  },
  ...
  },
  {
    ...
    off: "18%",
    info: { reviews: 200, discount: 40, brand: "The Gray Barn", availability: true, style: ' Modern & Contemporary' }
  ...
  },
  {
   ...
   [
    ...
    off: "15%",
    info: { reviews: 29, discount: 27, brand: " Furniture of America", availability: true, style: 'Traditional' }
  },
  {
    name: "Simple Living Dawson Circle Front Cabinet - Charcoal Grey",
    img_url:
   [
    "https://bit.ly/3LHroOU",
    ...
    off: "12%",
    info: { reviews: 200, discount: 5, brand: "Simple Living", availability: true, style: '$303.99' }
  },
  {
    ...
    off: "46%",
    info: { reviews: 300, discount: 20, brand: "Furniture of America", availability: true, style: 'Casual y' }
  },
  {
  ...
  },
  {
   ...
   [
    ...
    off: "17%",
    info: { reviews: 300, discount: 5, brand: "Parrot Uncle", availability: true, style: '' }
  },
  ]
        ...
        image.src=data.img_url[0];
  
         let divright = document.createElement("div");
         divright.setAttribute("id","divright");
        let circle =  document.createElement("div");
        circle.innerText=data.off;
    ...
    info.innerHTML=data.info;
      ...
      divright.append(circle,name,rating,price,divwish,btn)
      divmain.append(image,divright)
      div.append(divmain)
